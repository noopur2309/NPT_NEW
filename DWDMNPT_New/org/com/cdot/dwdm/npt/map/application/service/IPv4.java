...
*@return
*/
    public List<Integer> getAvailableIPs(Integer numberofIPs) {

        ArrayList<Integer> result = new ArrayList<Integer>();
        int numberOfBits;
        
        if(numberofIPs.intValue() == MapConstants.I_TWO)
        	numberofIPs= numberofIPs.intValue() + MapConstants.I_ONE;

        //System.out.println("numberofIPs :- "+numberofIPs);
        ...
        for (int i = 1; i < (numberOfIPs) && i < numberofIPs; i++) {
            ...
            ///System.out.println("Integer IP :- "+ourIP);
  ...
  /*************************************************************************************************************************************/  
    /**
	 * Imported API for Converting IPv4 address encoded as integer to string and back
	 */
	public static String integerToStringIP(Long intIpAdd) {
		return ((intIpAdd >> 24 ) & 0xFF) + "." +
    ...
    /**
    * Get an HashMap of all the IP addresses available for the IP and netmask/CIDR
    * given at initialization
    *
    *@return
    */
        public HashMap<String, Long> getAvailableIPsHashMap(Integer numberofIPs) {
...
*/
    ...
    public boolean validateIPAddress() {
        ...
        /**DBG => Need to Change the Matches to fix the Error Later*/
