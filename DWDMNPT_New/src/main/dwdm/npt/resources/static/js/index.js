...
//	print
	...
	/************************************************************************
	 * Modal for showing on going process status (saving map,running rwa)
	 ************************************************************************/
	function fShowClientServerCommunicationModal(text)
	{
		...
		$('#loadingModal').modal({ backdrop: 'static', keyboard: false });//disable click on black area/ esc key 
		$("#nptModal > img").attr('src','images/cdot-logo-animated.gif');
