...
//alert('stencilgraph created');

var rodam = new joint.shapes.basic.Rect({
    position: { x: 10, y: 20 },
...
var hub = new joint.shapes.basic.Rect({
    position: { x: 90, y: 20 },
    size: { width: 70, height: 50 },
    attrs: {
        rect: {
...
//alert('adding cells');
stencilGraph.addCells([link3]);

stencilPaper.on('cell:pointerdown', function(cellView, e, x, y) {
	
  alert("on stencil"); 

  $('body').append('<div id="flyPaperLink" style="position:fixed;z-index:100;opacity:.7;pointer-event:none;"></div>');
