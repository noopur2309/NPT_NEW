...
public class WebMainController {
    ...
    public @ResponseBody String updateHosting(@RequestBody String obj) throws JSONException {
        System.out.println("**************************** Map data : *******************************");///.getName()+ " and "+obj.getSName());
...
/*	
	...
	///@ResponseBody
    public String updateHosting(@RequestBody String name){
		///String name = obj.getName();
        System.out.println("Map data :"+ name);
		return "Success";
    }*/
